...
<head>
    ...
    <style>
        ...
        .pb-carouselWarp .pb-arrow-prev {
            left: 20px;
            background: #000000 url(<%=basePath%>resources/images/carousel/arrow-left.png) no-repeat center;
        }
        .pb-carouselWarp .pb-arrow-next {
            right: 20px;
            background: #000000 url(<%=basePath%>resources/images/carousel/arrow-right.png) no-repeat center;
        }
        ...
        .pb-carouselWarp[type='updown'] .pb-arrow-prev {
            top: 20px;
            background: #000000 url(<%=basePath%>resources/images/carousel/arrow-top.png) no-repeat center;
        }
        .pb-carouselWarp[type='updown'] .pb-arrow-next {
            top: auto;
            bottom: 20px;
            background: #000000 url(<%=basePath%>resources/images/carousel/arrow-bottom.png) no-repeat center;
        }
    </style>
                    ...
                    <div class="flex-caption">
                        ...
                        <div class="col-l">
                            <p style="text-indent:2em;">
                                Exam是国内首款网络考试系统。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。</p>
                            <p style="text-indent:2em;">软件完全开放且免费，并且有固定的开发团队提供技术支持</p>
                            <p style="text-indent:2em;">如果您对软件有任何反馈和建议，加入我们的QQ群747804577一起讨论吧</p>
                            <a class="btn btn-default btn-cta" href="user-register"><i
                                    class="fa fa-arrow-circle-down"></i> 马上注册开始答题</a>
                        </div>
                        <!-- Right column -->
                        <div class="col-r">
                            <div class="pb-carouselWarp demo1">
                                <ul class="pb-carousel">
                                    <li class="pb-this"><img src="<%=basePath%>resources/images/carousel/1.jpg" alt="" /></li>
                                    <li><img src="<%=basePath%>resources/images/carousel/2.jpg" alt=""/></li>
                                    <li><img src="<%=basePath%>resources/images/carousel/3.jpg" alt=""/></li>
                                    <li><img src="<%=basePath%>resources/images/carousel/4.jpg" alt=""/></li>
                                    <li><img src="<%=basePath%>resources/images/carousel/5.jpg" alt=""/></li>
                                </ul>
                ...
                <div class="copy">
                    <p>
                        Exam Copyright © <a href="http://www.exam.wangcl.xyz/" target="_blank">Exam</a> - <a href="."
                                                                                                             target="_blank">主页</a>
                        | <a href="http://www.exam.wangcl.xyz/" target="_blank">关于我们</a> | <a href="http://www.exam.wangcl.xyz/"
                                                                                         target="_blank">FAQ</a> | <a
...
<script src="resources/js/carousel.min.js" type="text/javascript" charset="utf-8"></script>
<!-- Bootstrap JS -->
<script type="text/javascript"
